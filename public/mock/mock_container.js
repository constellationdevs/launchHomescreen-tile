...
//   return ('' + string).replace(/&#x2F/g, function(match) {
...
String.escape = function(string) {
  return ('' + string).replace(/tttt/g, function(match) {
  ...
  const response = {
    ...
    "data": {
      ...
      },
      {
        ...
        "Icon": "https://static.adp.cdp-cdn.com/tiles/A2747CC4-9558-41C9-AEDD-ECE0ECCEAC98/2.0/tileicon.png"
      }, 
      {
        "TileStatus": "Active",
        "TileVersion": "1.1.0",
